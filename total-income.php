					...
					<div class="panel panel-default">
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <div class="row progress-labels">
								<h1 class="col-md-12 text-center">Rs <?php include 'counters/income-count.php' ?>0</h1>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <div class="row progress-labels">
								<h1 class="col-md-12 text-center">Rs <?php include 'counters/currentday-income.php' ?>0</h1>
								<!-- <div class="col-sm-6" style="text-align: right;">50%</div> -->
							</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <div class="row progress-labels">
								<h1 class="col-md-12 text-center">Rs <?php include 'counters/yesday-income.php' ?>0</h1>
								<!-- <div class="col-sm-6" style="text-align: right;">50%</div> -->
							</div>
