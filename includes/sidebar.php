<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <img src="includes/passport.jpg" class="img-responsive" alt="Profile Picture" width="50">
</div>
		...
		<ul class="nav menu">
			...
			<li class="<?php if($page=="income") {echo "active";}?>"><a href="total-income.php"> Rs. Total Income</a></li>
